  ...
  return (
    <div className="font-Josefin glass animate-fade-in-up shadow-2xl my-auto min-w-[320px] md:min-w-[360px] rounded-xl text-white overflow-hidden">
      <div className="text-2xl tracking-tighter p-5 font-semibold flex items-start flex-wrap gap-x-3 gap-y-1.5 flex-col bg-white/5">
        ...
        <div className="text-[10px] text-zinc-500 tracking-wider uppercase font-bold mt-0.5">
          Temporary Chat Room
        </div>
      </div>
      ...
      <div className="p-5 flex flex-col gap-y-3.5">
        <div
          className="font-Josefin hover:bg-zinc-200 transition-all duration-300 active:scale-[0.98] rounded-lg py-2.5 px-4 text-zinc-950 font-bold flex cursor-pointer justify-center bg-white shadow-md text-sm"
          onClick={() => {
            random();
          }}
        >
