  ...
  const features = [
    {
      ...
      title: "Secure Rooms",
      description:
        "Join temporary rooms with your friends and chat seamlessly in real-time.",
    },
    {
      icon: <Sparkle size={24} weight="duotone" className="text-white" />,
      title: "No Strings Attached",
      description:
        "No accounts, no databases, no logs. Messages exist only for the duration of the session.",
    },
    {
      icon: <ShieldCheck size={24} weight="duotone" className="text-white" />,
      title: "Privacy First",
      description:
        "Designed for those who value anonymity. Jump in, chat, and leave without a trace.",
    },
  ];
    ...
    <div className="min-h-screen w-full bg-[#030303] text-zinc-400 font-geist-sans flex flex-col justify-between selection:bg-zinc-800 selection:text-white relative overflow-x-hidden">
      ...
      <nav className="border-b border-zinc-900/60 px-6 py-5 md:px-12 flex justify-between items-center max-w-6xl w-full mx-auto backdrop-blur-[2px] sticky top-0 z-50 bg-[#030303]/80">
        ...
        >
          <img
            src="/favicon.png"
            alt="Chatty Logo"
            className="w-7 h-7 rounded-md shadow-md border border-zinc-850 group-hover:scale-110 transition-transform"
          />
          <span className="text-lg font-bold tracking-tighter text-white font-geist-sans">
            chatty
          </span>
        </div>
        <div className="flex items-center gap-x-5">
          ...
          <Link
            to="/join"
            className="border border-zinc-800 text-zinc-300 hover:text-white px-4 py-2 rounded-xl text-xs bg-zinc-950 hover:bg-zinc-900 transition-all font-geist-mono"
          >
            [ launch_app ]
          </Link>
        </div>
        ...
        <div className="animate-fade-in-up space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-sm md:text-base text-zinc-500 max-w-lg mx-auto leading-relaxed">
              No accounts. No logs. No persistence. Experience seamless
              real-time messaging designed for the modern web.
            </p>
          </div>
          <div className="flex flex-row gap-4 justify-center pt-2">
            <Link
              to="/join"
              className="group bg-white text-zinc-950 px-6 py-3 rounded-xl font-bold text-xs hover:bg-zinc-200 transition-all active:scale-95 flex items-center justify-center gap-x-2 font-geist-mono"
            >
              Get Started
              <ArrowRight
                size={14}
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center justify-center gap-x-2 px-6 py-3 rounded-xl border border-zinc-800 text-zinc-400 hover:text-white font-bold hover:bg-white/5 transition-all text-xs font-geist-mono"
            >
              <GithubLogo size={16} />
              Star on GitHub
            </a>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-20 md:px-12 w-full border-t border-zinc-900/60">
        <div className="mb-12 text-left space-y-1">
          <span className="text-[10px] text-zinc-650 tracking-widest uppercase font-bold block font-geist-mono">
            // specifications
          </span>
          ...
          <p className="text-zinc-500 text-xs md:text-sm font-medium">
            Zero compromises on speed, security, or aesthetics.
          </p>
        </div>
        ...
        <div className="border border-zinc-900 bg-[#070709] p-10 md:p-16 rounded-3xl text-center relative overflow-hidden">
          <div className="space-y-4 max-w-md mx-auto">
            ...
            <p className="text-zinc-500 text-xs md:text-sm leading-relaxed">
              Join thousands of users who trust Chatty for their temporary
              conversations. No account needed, ever.
            </p>
            <div className="flex flex-row gap-4 justify-center pt-2">
              <Link
                to="/join"
                className="bg-white text-zinc-950 px-6 py-3 rounded-xl font-bold text-xs hover:bg-zinc-200 transition-all active:scale-95 font-geist-mono"
              >
                Get Started Now
              </Link>
              <a
